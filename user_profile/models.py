...
class SiteSettings(models.Model):
    ...
    footer_signature = models.ImageField("Firma del footer", upload_to="site/", null=True, blank=True)
    products_hero_image = models.ImageField("Imagen del hero de productos", upload_to="site/", null=True, blank=True)
    products_hero_text = models.TextField("Texto del hero de productos", blank=True, default="")
    products_hero_text_en = models.TextField("Products hero text (EN)", blank=True, default="")
